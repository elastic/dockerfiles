...
RUN curl --retry 10 -S -L --output /tmp/elasticsearch.tar.gz https://artifacts-no-kpi.elastic.co/downloads/elasticsearch/elasticsearch-8.6.2-linux-$(arch).tar.gz
...
LABEL org.label-schema.build-date="2023-02-13T09:35:20.314882762Z" \
