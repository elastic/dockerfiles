...
RUN curl --retry 10 -S -L --output /tmp/elasticsearch.tar.gz https://artifacts-no-kpi.elastic.co/downloads/elasticsearch/elasticsearch-8.6.1-linux-$(arch).tar.gz
...
LABEL org.label-schema.build-date="2023-01-24T21:35:11.506992272Z" \
  ...
  org.opencontainers.image.created="2023-01-24T21:35:11.506992272Z" \
  org.opencontainers.image.documentation="https://www.elastic.co/guide/en/elasticsearch/reference/index.html" \
  org.opencontainers.image.licenses="Elastic-License-2.0" \
  org.opencontainers.image.revision="180c9830da956993e59e2cd70eb32b5e383ea42c" \
